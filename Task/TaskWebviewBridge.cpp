...
TaskWebViewBridge::TaskWebViewBridge(QObject *parent) : QObject(parent){

}
void TaskWebViewBridge::clickSignalToQt(const QString &eachp2,const QString &nodeName,const QString &nodeCode,const QString &loopXpath){
