...
void TaskSmartalert::smartAlertSelectAll(MCustomTaskSmartAlertSelectAll *selectAll){
...
void TaskSmartalert::smartAlertExtract(const QString &name){
...
void TaskSmartalert::smartAlertSelectAllExtract(const QString &name){
...
void TaskSmartalert::onSmartAlertCancel(bool checked){
    Q_UNUSED(checked);
    m_webView->page()->runJavaScript("smartAlertCancel()");
    this->block();
}
void TaskSmartalert::block(){
...
void TaskSmartalert::initAWidget(){
    ...
    connect(aWidget->cancelButton,&QPushButton::clicked,this,&TaskSmartalert::onSmartAlertCancel);
    stackedWidget->addWidget(aWidget);
}

void TaskSmartalert::initAWidgetSelectAll(){
    ...
    connect(aWidgetSelectAll->cancelButton,&QPushButton::clicked,this,&TaskSmartalert::onSmartAlertCancel);
    stackedWidget->addWidget(aWidgetSelectAll);
}

void TaskSmartalert::initImgWidget(){
    ...
    connect(imgWidget->cancelButton,&QPushButton::clicked,this,&TaskSmartalert::onSmartAlertCancel);
    stackedWidget->addWidget(imgWidget);

}
void TaskSmartalert::initImgWidgetSelectAll(){
    ...
    connect(imgWidgetSelectAll->cancelButton,&QPushButton::clicked,this,&TaskSmartalert::onSmartAlertCancel);
    stackedWidget->addWidget(imgWidgetSelectAll);
}
void TaskSmartalert::initInputWidget(){
    ...
    connect(inputWidget->cancelButton,&QPushButton::clicked,this,&TaskSmartalert::onSmartAlertCancel);
    stackedWidget->addWidget(inputWidget);

}
void TaskSmartalert::initInputInputWidget(){
    ...
    connect(cancelBtn,&QPushButton::clicked,this,&TaskSmartalert::onSmartAlertCancel);
...
void TaskSmartalert::initCommonWidget(){
    ...
    connect(commonWidget->cancelButton,&QPushButton::clicked,this,&TaskSmartalert::onSmartAlertCancel);
    stackedWidget->addWidget(commonWidget);

}

void TaskSmartalert::initCommonWidgetSelectAll(){
    ...
    connect(commonWidgetSelectAll->cancelButton,&QPushButton::clicked,this,&TaskSmartalert::onSmartAlertCancel);
