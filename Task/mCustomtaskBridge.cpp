...
MCustomTaskBridge::MCustomTaskBridge(QObject *parent) : QObject(parent){

}
void MCustomTaskBridge::clickSignalToQt(const QString &eachp2,const QString &nodeName,const QString &nodeCode,const QString &loopXpath){
