...
#include <QCloseEvent>
#include <QDebug>
RunAlertDialog::RunAlertDialog(const QString &name,QWidget *parent) : QDialog(parent)
{
    setWindowFlags(Qt::Dialog| Qt::WindowCloseButtonHint);
    setFixedSize(600,230);
    ...
    nameDesc->setText(tr(QString("<span style='color:rgb(153,153,153)'>任务</span>   <span style='font-size:14px;font-family:Microsoft YaHei;'>%1</span>").arg(name).toUtf8()));
...
void RunAlertDialog::showMessage(MessageType type, const QString &summary){
...
void RunAlertDialog::initBottomUi(){
...
void RunAlertDialog::closeEvent(QCloseEvent *event){
    event->accept();
